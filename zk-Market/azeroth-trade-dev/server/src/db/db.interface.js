...
export class DBinterface {
     ...
     * @returns {}
     */
    async SELECT(SELECT_LIST, FROM = undefined, WHERE = undefined,) {
        let query = 'SELECT '
        ...
        if (WHERE) {
            query += ` WHERE ${_.get(WHERE, 'key')}="${_.get(WHERE, 'value')}"`
        }
     ...
     */
    async INSERT(TABLE_NAME, KEYS, VALUES) {
    ...
    async UPDATE(TABLE_NAME, SET_KEY, SET_VALUE, WHERE_KEY, WHERE_VALUE) {
