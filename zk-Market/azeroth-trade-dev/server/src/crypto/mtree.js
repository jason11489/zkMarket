export class Mtree {
    constructor(root, intermediateHashes, index) {
        this.root = root;
    ...
    toIntermediateHashesArray() {
        let intermediateHashesArray = [];
        for (const [i, e] of this.intermediateHashes.entries()) {
            intermediateHashesArray.push(e);
        }
        return intermediateHashesArray;
    }
